...
* GitHub: [@sruthikommati](Got it! You want the README fully customized with **your details (Sruthi Kommati)** and remove all other names/references. I can rewrite it accordingly. Here's a clean, personalized version:
...
* GitHub: [@sruthikommati](https://github.com/sruthikommati)
